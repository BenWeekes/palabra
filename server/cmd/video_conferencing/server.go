...
func main() {
	...
	router.HandleFunc("/v1/login", http.HandlerFunc(requestHandler.Login))
	router.HandleFunc("/v1/channel", http.HandlerFunc(requestHandler.CreateChannel))
	router.HandleFunc("/v1/channel/join", http.HandlerFunc(requestHandler.JoinChannel))
	router.HandleFunc("/v1/channel/share", http.HandlerFunc(requestHandler.ShareChannel))
